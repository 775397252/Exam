        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview  ">
                ...
                <ul class="treeview-menu">
                    <li><a href="/admin/permission/index">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>权限列表</a></li>
                    <li><a href="/admin/role/index">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>角色列表</a></li>
            ...
            <li class="treeview   active ">
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="/admin/paper/index">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>试卷列表</a></li>
                </ul>
            </li>
            <li class="treeview  ">
                <a href="#"><i class="fa fa-child"></i> <span>学生管理</span> <i class="fa fa-angle-left pull-right"> </i></a>
                <ul class="treeview-menu">
                    <li><a href="/admin/student/index">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>学生列表</a></li>
                </ul>
            </li>
